    ...
    <div className="page-container flex min-h-[50vh] flex-col items-center justify-center py-16 text-center">
      ...
      <p className="mt-3 max-w-lg text-sm text-[var(--foreground-muted)]">
        ...
        : message.includes("Connection terminated") ||
          ...
          "Database is not reachable. Check DATABASE_URL (mongodb:// or mongodb+srv://USER:PASSWORD@CLUSTER.mongodb.net/DATABASE and that MongoDB Atlas allows your IP (or 0.0.0.0/0 for Vercel)."
