...
2. Copy the `mongodb+srv://USER:PASSWORD@CLUSTER.mongodb.net/DATABASE` URI.
...
export DATABASE_URL="mongodb+srv://USER:PASSWORD@CLUSTER.mongodb.net/DATABASE"
...
| Name | Value |
|------|--------|
| `DATABASE_URL` | Your `mongodb+srv://USER:PASSWORD@CLUSTER.mongodb.net/DATABASE` Atlas URI |
